...
public class StringData {
    ...
    public String web_user_id = "";   // Foreign Key
    public String user_email = ""; // getting it from joined user_role table.
    ...
    public String toString() {
        return ", User Role Id: " + this.web_user_id
                + ", User Role Type: " + this.user_email;
    }
}
